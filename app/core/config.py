...
class Settings(BaseSettings):
    ...
    MONGO_MIN_POOL_SIZE: int = Field(10, ge=1, description="Minimum connection pool size")
    MONGO_MAX_POOL_SIZE: int = Field(100, ge=10, description="Maximum connection pool size")
    ...
    SPARK_EXECUTOR_INSTANCES: int = Field(
        2, ge=1,
