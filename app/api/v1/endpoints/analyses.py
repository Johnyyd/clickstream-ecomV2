...
async def get_comprehensive_analysis(
    ...
    """
    Get comprehensive analysis combining all analytics modules
    """
    try:
        from app.analytics.comprehensive import analyze_comprehensive
